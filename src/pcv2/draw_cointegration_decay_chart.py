...
class CointegrationDecayChart:
    ...
    def _load_data(self):
        ...
        print(f"Loaded last {self.max_months} months: "
    ...
    def generate(self):
        ...
        axs[0].text(0.02, 0.82,
                    ...
                    f"Full {self.max_months}m p-value = {full['p_value']:.5f}\n"
                    f"Beta = {full['beta']:.4f}\n"
...
if __name__ == "__main__":
    ...
    sym1 = "ETH"
    sym2 = "BTC"
    max_months = DEFAULT_COINTEGRATION_CORRELATION_MONTHS
    ...
    if len(sys.argv) > 1:
        ...
        if len(args) == 0:
            ...
            print(f"Usage: python draw_cointegration_decay_chart.py [CSV_FILE] SYM1 SYM2 [max_months]")
            print("Example: python draw_cointegration_decay_chart.py ETH SOL 12")
            sys.exit(1)

    chart = CointegrationDecayChart(sym1, sym2, csv_file, max_months)
    chart.generate()
